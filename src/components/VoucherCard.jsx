    ...
    <div id="printArea" className="w-[14.8cm] bg-white ">
      ...
      <div className=" text-xs mb-8">
        <div className=" ">
          ...
          <p>Kpay,Wave - 09250157834</p>
          <p>KBZ Bank - 027301039583931</p>
          <p>AYA Bank - 200036348521</p>
        </div>
        <div className="  ">
          <h2 className="font-bold text-xl">NMH IT</h2>
