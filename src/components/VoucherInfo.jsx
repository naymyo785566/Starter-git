...
const VoucherInfo = () => {
  ...
  // Utility function to generate a random voucher number
    ...
    <div className="grid grid-cols-4 gap-5">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col h-full" id="infoForm">
        ...
        <button
          type="submit"
          form="infoForm"
          className="text-white inline-flex gap-3 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
        >
